...
from .views import HomePageView, AboutPageView, AboutContactView, ProductIndexView, ProductShowView, ProductCreateView, CartView, CartRemoveAllView, ImageViewFactory, ImageViewNoDI
...
urlpatterns = [
    ...
    path('products/product-created/', ProductCreateView.as_view(), name='product-created'),

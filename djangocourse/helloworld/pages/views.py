...
class CartView(View):
    ...
    def get(self, request):
        # Obtener los datos de los productos disponibles
        products = {
        ...
        if cart_product_data is None:
            cart_product_data = {}
        cart_products = {key: product for key, product in products.items() if str(key) in cart_product_data}
